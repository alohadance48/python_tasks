...
while while_0 == 1:
    ...
    if yes_no == "yes":
        ...
        if yes_no == "yes":
            ...
            if jump == 1 and masiv >= masiv_1 and masiv>= index_stupen_1:
                print("Ты на первой ступени! Она равна", masiv_1)
                index_stupen_2 = index_stupen_2 - 1 
                While_1 = 1
            elif jump == 2 and masiv >= masiv_2 and masiv_1>=index_stupen_2:
                print("Ты на второй ступени! Она равна", masiv_2)
                index_stupen_3 = index_stupen_3 - 2
                While_2 = 2
            elif jump == 3 and masiv >= masiv_3 and masiv_3 >= index_stupen_3:
                print("Ты на третьей ступени! Она равна", masiv_3)
                index_stupen_4 = index_stupen_4 - 3 
                While_3 = 3
            elif jump == 4 and masiv >= masiv_4 and masiv_4>= index_stupen_4:
            ...
            while While_3 == 3:
                ...
                print("Твоя сила прыжка :",masiv_3)
                if jump_3 == 4 and masiv_3 >= masiv_4:
                    print("Ты на четвертой ступени! Она равна", masiv_4)
                    While_4 = 4
                    While_3 = 0  #  цикл While_3
